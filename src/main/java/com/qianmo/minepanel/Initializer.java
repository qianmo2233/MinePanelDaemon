...
public class Initializer implements ServletContextListener, ApplicationListener<WebServerInitializedEvent> {
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        MinePanelDaemon.getLogger().info("FTP server is stopped!");
    }
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ftpServer.Start();
            MinePanelDaemon.getLogger().info("FTP server is started!");
        } catch (Exception e){
            e.printStackTrace();
        ...
        if(!daemonConfiguration.getDocker().equals("")) {
            try {
                ...
                MinePanelDaemon.getLogger().warn("Failed to connect docker:" + e);
            }
        }
    }
    ...
    public void onApplicationEvent(WebServerInitializedEvent webServerInitializedEvent) {
        MinePanelDaemon.getLogger().info("Daemon runs on port " + webServerInitializedEvent.getWebServer().getPort());
    }
